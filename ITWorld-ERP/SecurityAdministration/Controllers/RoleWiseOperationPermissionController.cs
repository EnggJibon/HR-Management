...
namespace SecurityAdministration.Controllers
{
    public class RoleWiseOperationPermissionController : Controller
    {
        ...
        public ActionResult RolewiseOperationPermissionList([DataSourceRequest]DataSourceRequest request)
        {
            var rolewiseOperationPermissionList = _unitOfWork.RolewiseOperationPermissionRepository.GetAll();
            return Json(rolewiseOperationPermissionList.ToDataSourceResult(request));
        }
    }
}
