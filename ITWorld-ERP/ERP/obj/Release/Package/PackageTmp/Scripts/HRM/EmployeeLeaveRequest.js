...
$(document).ready(function () {
    ...
    //$("#EmployeeLeaveRequest_ApprovalDate").kendoDatePicker({
    //    format: 'dd-MMM-yyyy',
    //}).attr("readonly", true);
...
function clearData() {
    ...
    $('#EmployeeLeaveRequest_RequestDate').val("");
    $('#EmployeeLeaveRequest_LeaveTypeId').val("");
    $('#EmployeeLeaveRequest_IsHalfDay').prop("checked", false);
    $('#EmployeeLeaveRequest_LeaveFrom').val("");
    $('#EmployeeLeaveRequest_LeaveTo').val("");
    ...
    $('#EmployeeLeaveRequest_ApprovalStatusId').val("");
    $("#hdnIsInsert").val(true);
}
