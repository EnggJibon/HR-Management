...
$(document).ready(function () {
    ...
    $('#EmployeeAttendanceInformation_Year').kendoDatePicker({
        format: " yyyy ",
    });
...
function setInformation(data) {
    if (data != null) {
        if (data.Employee != null) {
            ...
            var month = $('#EmployeeAttendanceMonthList').val();
...
$(document).ready(function () {
    ...
    $('#EmployeeAttendanceMonthList').attr('disabled', false);
    $('#EmployeeAttendanceInformation_Year').data('kendoDatePicker').enable(true);

    $("#chkDate").change(function () {

        if ($("#chkDate").is(':checked')) {
            $('#EmployeeAttendanceInformation_Date').data('kendoDatePicker').enable(true);
            $('#EmployeeAttendanceMonthList').attr('disabled', true);
            $('#EmployeeAttendanceInformation_Year').data('kendoDatePicker').enable(false);
        }
        else {
            $('#EmployeeAttendanceInformation_Date').data('kendoDatePicker').enable(false);
            $('#EmployeeAttendanceMonthList').attr('disabled', false);
